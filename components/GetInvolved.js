...
export default () => {
  ...
  return (
    <div className="flex justify-center pt-[40px] mb-[50px]">
      <div className="w-2/3">
          ...
          <div className="flex flex-col w-full rounded-sm">
              <div className="flex w-1/2 lg:w-2/3 justify-center mt-5 flex-col lg:flex-row">
                  <input
                  className="bg-transparent appearance-none mb-2 lg:mb-0 w-full lg:w-2/3 border-4 border-gray-900 rounded py-2 px-4 text-gray-900 leading-tight focus:outline-none focus:border-gray-600"
                  type="text"
                  ...
                  />
                  <button
                  className={`flex hover:bg-gray-100 justify-center border-4 border-gray-900 lg:ml-2 w-full lg:w-1/3 bg-brand2 focus:shadow-outline focus:outline-none text-center font-bold py-2 px-4 rounded ${
